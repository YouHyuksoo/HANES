...
CREATE OR REPLACE PACKAGE BODY PKG_WORKFLOW AS
    ...
    BEGIN
        ...
        SELECT 'EQUIPMENT', 'DAILY',
               ...
               0
          FROM (SELECT DISTINCT EQUIP_CODE FROM EQUIP_INSPECT_ITEM_POOL WHERE INSPECT_TYPE='DAILY' AND USE_YN='Y') t
        ...
        SELECT 'EQUIPMENT', 'PERIODIC',
               ...
               COUNT(CASE WHEN l.OVERALL_RESULT IS NOT NULL THEN 1 END),
               0
          FROM (SELECT DISTINCT EQUIP_CODE FROM EQUIP_INSPECT_ITEM_POOL WHERE INSPECT_TYPE='PERIODIC' AND USE_YN='Y') t
