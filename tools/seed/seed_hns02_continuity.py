...
checks = [
 ...
 ("생산실적 goodQty", f"SELECT NVL(SUM(GOOD_QTY),0) FROM PROD_RESULTS WHERE RESULT_NO='{PR}'"),
 ("기발행 FG(검사전=0)", f"SELECT COUNT(*) FROM FG_LABELS WHERE ORDER_NO='{WO}'"),
