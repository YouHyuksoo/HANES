...
const KNOWN_LEAF_CODES: ReadonlySet<string> = new Set<string>([
  ...
  // MATERIAL
  'MAT_ARRIVAL','MAT_ARRIVAL_RESULT','MAT_ARRIVAL_TRANSACTION','MAT_RECEIVE_LABEL','MAT_RECEIVE','MAT_RECEIVE_HISTORY','MAT_REQUEST',
  ...
  // PRODUCTION
  'PROD_MONTHLY_PLAN','PROD_SIMULATION','PROD_SPEC_SETUP','PROD_KITTING','PROD_ORDER','PROD_RESULT','PROD_PROGRESS',
  'PROD_INPUT_MANUAL','PROD_INPUT_KIOSK','PROD_INPUT_MACHINE','PROD_INPUT_INSPECT','PROD_INPUT_EQUIP',
  'PROD_RESULT_SUMMARY','PROD_WIP_STOCK','PROD_WIP_MAT_STOCK','PROD_WIP_MAT_TRANS','QC_REWORK','QC_REWORK_HISTORY','PROD_REPAIR',
  // INSPECTION
  'INSP_RESULT','INSP_TERMINAL_RESULT','INSP_HISTORY','INSP_PROTOCOL',
  // QUALITY
  'QC_IQC_ITEM','QC_IQC_PART_SPEC','QC_IQC','QC_IQC_HISTORY','QC_CONCESSION','QC_DEFECT',
  'QC_REWORK_INSPECT','QC_INSPECT','QC_REQUEST_INSPECT','QC_SELF_INSPECT_HISTORY',
  ...
  // SHIPPING
  'SHIP_PACK_RESULT','SHIP_PACK','SHIP_BOX_STOCK','SHIP_PALLET','SHIP_CONFIRM','SHIP_ORDER','SHIP_HISTORY','SHIP_RETURN',
  // SALES
