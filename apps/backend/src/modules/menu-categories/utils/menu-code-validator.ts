...
const KNOWN_LEAF_CODES: ReadonlySet<string> = new Set<string>([
  ...
  'PROD_RESULT_SUMMARY','PROD_LABEL_REPRINT','PROD_WIP_STOCK','PROD_FG_STOCK','PROD_WIP_MAT_STOCK','PROD_WIP_MAT_TRANS','PROD_PRODUCT_TRANS','QC_REWORK','QC_REWORK_HISTORY','PROD_REPAIR',
  // INSPECTION
  'INSP_INTEGRATED','INSP_STRUCTURE','INSP_RESULT','INSP_TERMINAL_RESULT','INSP_HISTORY','INSP_PROTOCOL',
  // QUALITY
  'QC_IQC_ITEM','QC_IQC_PART_SPEC','QC_TERMINAL_CRIMP_SPEC','QC_INSPECT_ITEM_SPEC','QC_INSPECT_AID','QC_AQL','QC_IQC','QC_IQC_HISTORY','QC_IQC_REQUEST_LOT','QC_CONCESSION','QC_DEFECT',
