...
const KNOWN_LEAF_CODES: ReadonlySet<string> = new Set<string>([
  ...
  'MAT_ISSUE','MAT_ISSUE_OTHER','MAT_LOT','MAT_LOT_SPLIT','MAT_LOT_MERGE','MAT_SHELF_LIFE','MAT_SCRAP',
  ...
  // QUALITY
  'QC_IQC_ITEM','QC_IQC','QC_IQC_HISTORY','QC_CONCESSION','QC_DEFECT','QC_REWORK_INSPECT','QC_INSPECT',
