...
export class TerminalCrimpSpecService {
  ...
  async create(dto: CreateTerminalCrimpSpecDto, company: string, plant: string, userId: string) {
    ...
    const entity = this.repo.create({
      ...
      applicatorDisk: dto.applicatorDisk ?? null,
      applicatorLifeShots: dto.applicatorLifeShots ?? null,
      sampleLotQty: dto.sampleLotQty ?? null,
  ...
  async update(specId: number, dto: UpdateTerminalCrimpSpecDto, company: string, plant: string, userId: string) {
    ...
    const patch: Partial<TerminalCrimpSpec> = {
      ...
      ...(dto.applicatorDisk !== undefined ? { applicatorDisk: dto.applicatorDisk } : {}),
      ...(dto.applicatorLifeShots !== undefined ? { applicatorLifeShots: dto.applicatorLifeShots } : {}),
      ...(dto.sampleLotQty !== undefined ? { sampleLotQty: dto.sampleLotQty } : {}),
