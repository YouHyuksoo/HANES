 ...
 * @description 고객클레임 DTO — 생성, 수정, 조회, 조사, 대응, CAPA 연계
 *
 * 초보자 가이드:
...
export class CreateComplaintDto {
  ...
  @ApiPropertyOptional({ description: '클레임 품목 코드', maxLength: 50 })
  @IsOptional()
  @IsString()
  @MaxLength(50)
  itemCode?: string;
  ...
  @ApiProperty({ description: '클레임 유형 (QUALITY/DELIVERY/DAMAGE)', maxLength: 30 })
  @IsString()
  @MaxLength(30)
  complaintType: string;

  @ApiPropertyOptional({ description: '클레임 내용', maxLength: 2000 })
  @IsOptional()
  @IsString()
  @MaxLength(2000)
  description?: string;
  ...
  @ApiPropertyOptional({ description: '클레임 비용' })
  @IsOptional()
  @Type(() => Number)
  @IsNumber()
  costAmount?: number;
...
export class ComplaintQueryDto {
  ...
  @ApiPropertyOptional({ description: '클레임 유형 필터' })
  @IsOptional()
  @IsString()
  complaintType?: string;
  ...
  @ApiPropertyOptional({ description: '검색어 (클레임번호, 고객명, 품목코드)' })
  @IsOptional()
  @IsString()
  search?: string;
