 ...
 *
 * 초보자 가이드:
 * 1. **클레임 API**: /api/v1/quality/complaints
 *    - GET    /complaints              : 목록 조회 (페이지네이션)
 *    - GET    /complaints/stats        : 상태별 통계
 *    - GET    /complaints/:id          : 단건 조회
 *    - POST   /complaints              : 등록
 *    - PUT    /complaints/:id          : 수정
 *    - DELETE /complaints/:id          : 삭제
 *    - PATCH  /complaints/:id/investigate : 조사 시작
 *    - PATCH  /complaints/:id/respond     : 대응 완료
 *    - PATCH  /complaints/:id/resolve     : 해결
 *    - PATCH  /complaints/:id/close       : 종료
 *    - PATCH  /complaints/:id/link-capa   : CAPA 연계
 *
...
export class ComplaintController {
  ...
  @Patch('complaints/:id/investigate')
