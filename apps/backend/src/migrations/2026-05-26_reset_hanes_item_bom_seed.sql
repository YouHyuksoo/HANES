DECLARE
  ...
  PROCEDURE add_item(
    ...
    p_customer     VARCHAR2 DEFAULT 'HANES',
  ...
  BEGIN
    INSERT INTO ITEM_MASTERS (
      ...
      SPEC, REV, UNIT, CUSTOMER, VENDOR, LEAD_TIME, SAFETY_STOCK,
      ...
      p_spec, 'A', p_unit, p_customer, p_vendor, p_lead_time, p_safety_stock,
...
BEGIN
  ...
  add_item('FG-HNS-001', 'Engine Room Harness', 'FINISHED', 'HARNESS', 'Engine room main wire harness', 'EA', 'HANES', NULL, 5, 20, 1, 10, 'N');
  add_item('FG-HNS-002', 'Instrument Panel Harness', 'FINISHED', 'HARNESS', 'IP cockpit wire harness', 'EA', 'HANES', NULL, 5, 20, 1, 10, 'N');
  add_item('FG-HNS-003', 'Door Main Harness', 'FINISHED', 'HARNESS', 'Front door main wire harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');
  add_item('FG-HNS-004', 'Roof Harness', 'FINISHED', 'HARNESS', 'Roof lamp and antenna harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');
  add_item('FG-HNS-005', 'Seat Harness', 'FINISHED', 'HARNESS', 'Power seat control harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');
  add_item('FG-HNS-006', 'Battery Cable Harness', 'FINISHED', 'HARNESS', 'Battery cable and ground harness', 'EA', 'HANES', NULL, 5, 15, 1, 10, 'N');
  add_item('FG-HNS-007', 'Tail Lamp Harness', 'FINISHED', 'HARNESS', 'Rear lamp wire harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');
  add_item('FG-HNS-008', 'HVAC Harness', 'FINISHED', 'HARNESS', 'HVAC control wire harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');
  add_item('FG-HNS-009', 'ABS Sensor Harness', 'FINISHED', 'HARNESS', 'Wheel speed sensor harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');
  add_item('FG-HNS-010', 'Camera Harness', 'FINISHED', 'HARNESS', 'Camera and ADAS harness', 'EA', 'HANES', NULL, 4, 20, 1, 10, 'N');

  add_item('WIP-HNS-001', 'Engine Room Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-001', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-002', 'IP Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-002', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-003', 'Door Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-003', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-004', 'Roof Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-004', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-005', 'Seat Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-005', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-006', 'Battery Cable Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-006', 'EA', 'HANES', NULL, 3, 25, 1, 20, 'N');
  add_item('WIP-HNS-007', 'Tail Lamp Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-007', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-008', 'HVAC Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-008', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-009', 'ABS Sensor Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-009', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');
  add_item('WIP-HNS-010', 'Camera Sub Harness', 'SEMI_PRODUCT', 'SUB_ASSY', 'Sub assembly for FG-HNS-010', 'EA', 'HANES', NULL, 3, 30, 1, 20, 'N');

  add_item('RM-WIRE-001', 'TXL Wire 0.35 Red', 'RAW_MATERIAL', 'WIRE', 'TXL 0.35SQ red automotive wire', 'M', 'HANES', 'WIRE-VENDOR', 7, 500, 100, 1000, 'Y', 'ROLL', 'WH-RM-WIRE');
  add_item('RM-WIRE-002', 'TXL Wire 0.50 Black', 'RAW_MATERIAL', 'WIRE', 'TXL 0.50SQ black automotive wire', 'M', 'HANES', 'WIRE-VENDOR', 7, 500, 100, 1000, 'Y', 'ROLL', 'WH-RM-WIRE');
  add_item('RM-WIRE-003', 'AVSS Wire 0.75 Blue', 'RAW_MATERIAL', 'WIRE', 'AVSS 0.75SQ blue automotive wire', 'M', 'HANES', 'WIRE-VENDOR', 7, 500, 100, 1000, 'Y', 'ROLL', 'WH-RM-WIRE');
  add_item('RM-WIRE-004', 'Shield Cable 2C', 'RAW_MATERIAL', 'WIRE', 'Shielded 2 core signal cable', 'M', 'HANES', 'WIRE-VENDOR', 10, 200, 50, 500, 'Y', 'ROLL', 'WH-RM-WIRE');
  add_item('RM-TERM-001', 'Terminal Receptacle 0.64', 'RAW_MATERIAL', 'TERMINAL', '0.64 series receptacle terminal', 'EA', 'HANES', 'TERM-VENDOR', 10, 5000, 1000, 5000, 'Y', 'BAG', 'WH-RM-TERM');
  add_item('RM-TERM-002', 'Terminal Tab 2.8', 'RAW_MATERIAL', 'TERMINAL', '2.8 series tab terminal', 'EA', 'HANES', 'TERM-VENDOR', 10, 3000, 1000, 5000, 'Y', 'BAG', 'WH-RM-TERM');
  add_item('RM-CONN-001', 'Connector Housing 12P', 'RAW_MATERIAL', 'CONNECTOR', '12 pole connector housing', 'EA', 'HANES', 'CONN-VENDOR', 14, 500, 100, 1000, 'Y', 'BOX', 'WH-RM-CONN');
  add_item('RM-CONN-002', 'Connector Housing 24P', 'RAW_MATERIAL', 'CONNECTOR', '24 pole connector housing', 'EA', 'HANES', 'CONN-VENDOR', 14, 500, 100, 1000, 'Y', 'BOX', 'WH-RM-CONN');
  add_item('RM-CONN-003', 'Waterproof Connector 6P', 'RAW_MATERIAL', 'CONNECTOR', 'Waterproof 6 pole connector housing', 'EA', 'HANES', 'CONN-VENDOR', 14, 300, 100, 1000, 'Y', 'BOX', 'WH-RM-CONN');
  add_item('RM-SEAL-001', 'Wire Seal 0.64', 'RAW_MATERIAL', 'SEAL', 'Wire seal for 0.64 terminal', 'EA', 'HANES', 'SEAL-VENDOR', 10, 3000, 1000, 5000, 'Y', 'BAG', 'WH-RM-CONN');
  add_item('RM-CLIP-001', 'Harness Clip', 'RAW_MATERIAL', 'CLIP', 'Plastic harness fixing clip', 'EA', 'HANES', 'CLIP-VENDOR', 7, 1000, 200, 2000, 'Y', 'BAG', 'WH-RM-COMP');
  add_item('RM-TAPE-001', 'PVC Tape 19mm', 'RAW_MATERIAL', 'TAPE', 'Black PVC harness wrapping tape', 'M', 'HANES', 'TAPE-VENDOR', 7, 300, 10, 100, 'Y', 'ROLL', 'WH-RM-COMP');
  add_item('RM-TUBE-001', 'Corrugated Tube 7mm', 'RAW_MATERIAL', 'TUBE', 'Split corrugated tube 7mm', 'M', 'HANES', 'TUBE-VENDOR', 7, 300, 50, 500, 'Y', 'ROLL', 'WH-RM-COMP');
  add_item('RM-LABEL-001', 'Barcode Label', 'RAW_MATERIAL', 'LABEL', 'Product barcode label', 'EA', 'HANES', 'LABEL-VENDOR', 5, 1000, 1000, 5000, 'Y', 'BOX', 'WH-RM-LABEL');
  add_item('RM-FUSE-001', 'Inline Fuse Holder', 'RAW_MATERIAL', 'ELECTRIC', 'Inline fuse holder assembly', 'EA', 'HANES', 'ELEC-VENDOR', 14, 200, 50, 500, 'Y', 'BOX', 'WH-RM-ELEC');
  add_item('RM-GROM-001', 'Rubber Grommet', 'RAW_MATERIAL', 'GROMMET', 'Body pass-through rubber grommet', 'EA', 'HANES', 'RUBBER-VENDOR', 14, 200, 50, 500, 'Y', 'BOX', 'WH-RM-COMP');
