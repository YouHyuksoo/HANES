...
CREATE SEQUENCE SEQ_INTER_LOGS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_CONSUMABLE_LOGS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_CONSUMABLE_MOUNT_LOGS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_MOLD_USAGE_LOGS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_SCHEDULER_NOTIFICATIONS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_SCHEDULER_LOGS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_PHYSICAL_INV_SESSIONS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_SPC_DATA START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_REPAIR_ORDERS START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_IQC_TEMPLATES START WITH 1 INCREMENT BY 1 NOCACHE;
