...
async function loadPageComponent(path: string): Promise<ComponentType | null> {
  ...
  switch (path) {
    ...
    case "/inspection/hipot-result": {
      const mod = await import("./page-registries/inspection__hipot-result.generated");
      component = mod.getPageComponent();
      break;
    }
    ...
    case "/inspection/leak-result": {
      const mod = await import("./page-registries/inspection__leak-result.generated");
      component = mod.getPageComponent();
      break;
    }
    ...
    case "/production/input-assembly-b": {
      const mod = await import("./page-registries/production__input-assembly-b.generated");
      component = mod.getPageComponent();
      break;
    }
    ...
    case "/production/input-kiosk-b": {
      const mod = await import("./page-registries/production__input-kiosk-b.generated");
      component = mod.getPageComponent();
      break;
    }
    ...
    case "/quality/iqc-request-lot": {
      const mod = await import("./page-registries/quality__iqc-request-lot.generated");
      component = mod.getPageComponent();
      break;
    }
    case "/quality/msa": {
    ...
    case "/quality/ncr": {
      const mod = await import("./page-registries/quality__ncr.generated");
      component = mod.getPageComponent();
      break;
    }
    case "/quality/oqc": {
