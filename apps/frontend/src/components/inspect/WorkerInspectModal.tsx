...
/**
 * @file components/inspect/WorkerInspectModal.tsx
 * @description 작업자 설비 자가점검 모달 (공용) — 실적입력(가공)과 통전·단자검사가 함께 쓴다
 *
 * 초보자 가이드:
...
type WorkerInspectModalProps = InspectModalProps;

export default function WorkerInspectModal({ isOpen, onClose, onDone, context }: WorkerInspectModalProps) {
