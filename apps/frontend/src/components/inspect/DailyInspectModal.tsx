...
/**
 * @file components/inspect/DailyInspectModal.tsx
 * @description 설비 일일점검 입력 모달 (공용) — 실적입력(가공)과 통전·단자검사가 함께 쓴다
 *
 * 초보자 가이드:
...
type DailyInspectModalProps = InspectModalProps;
...
export default function DailyInspectModal({ isOpen, onClose, onDone, context }: DailyInspectModalProps) {
