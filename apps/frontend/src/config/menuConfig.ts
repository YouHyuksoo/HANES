...
export const menuConfig: MenuConfigItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { code: "PROD_INPUT_KIOSK_B", labelKey: "menu.production.inputKioskB", path: "/production/input-kiosk-b" },
      ...
      { code: "PROD_PRODUCTIVITY", labelKey: "menu.production.productivity", path: "/production/productivity" },
  ...
  },
  {
    ...
    children: [
      ...
      { code: "INSP_TORQUE_RESULT", labelKey: "menu.inspection.torqueResult", path: "/inspection/torque-result" },
      { code: "INSP_VISION_RESULT", labelKey: "menu.inspection.visionResult", path: "/inspection/vision-result" },
      { code: "INSP_RELAY_RESULT", labelKey: "menu.inspection.relayResult", path: "/inspection/relay-result" },
  ...
  },
  {
    ...
    children: [
      ...
      { code: "QC_LIMIT_SAMPLE", labelKey: "menu.master.limitSample", path: "/master/limit-sample" },
