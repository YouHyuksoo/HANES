...
export function createMoldMgmtGridColumns({
  ...
  return [
    ...
    },
    {
      ...
      header: headerWithHelp('moldCode', t('equipment.mold.moldCode')),
      size: 130,
    ...
    },
    {
      ...
      header: headerWithHelp('moldName', t('equipment.mold.moldName')),
      size: 160,
      meta: { filterType: 'text' as const },
    },
    {
      accessorKey: 'moldType',
      header: headerWithHelp('moldType', t('equipment.mold.moldType')),
      size: 110,
    ...
    },
    {
      ...
      header: headerWithHelp('itemCode', t('equipment.mold.itemCode')),
      size: 130,
      meta: { filterType: 'text' as const },
    },
    {
      accessorKey: 'cavity',
      header: headerWithHelp('cavity', t('equipment.mold.cavity')),
      size: 80,
    ...
    },
    {
      ...
      header: headerWithHelp('currentShots', t('equipment.mold.currentShots')),
      size: 100,
      meta: { filterType: 'number' as const },
    ...
    },
    {
      ...
      header: headerWithHelp('guaranteedShots', t('equipment.mold.guaranteedShots')),
      size: 100,
      meta: { filterType: 'number' as const },
      cell: ({ getValue }) => <span className="font-mono text-right block">{(getValue<number>() ?? 0).toLocaleString()}</span>,
    },
    {
      ...
      header: headerWithHelp('shotRate', t('equipment.mold.shotRate')),
      size: 90,
