  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-xl font-bold text-text flex items-center gap-2"><CalendarCheck className="w-7 h-7 text-primary" />정기점검</h1>
          <p className="text-text-muted mt-1">설비 정기점검 결과를 등록하고 관리합니다.</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-3">
        <StatCard label="전체 점검" value={stats.total} icon={Shield} color="blue" />
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={editingItem ? "정기점검 수정" : "정기점검 등록"} size="md">
