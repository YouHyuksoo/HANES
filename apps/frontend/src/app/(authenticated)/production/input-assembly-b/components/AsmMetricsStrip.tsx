...
/**
 * @file production/input-assembly-b/components/AsmMetricsStrip.tsx
...
interface AsmMetricsStripProps {
  orderNo?: string;
  planQty?: number;
  workers: number;
  refreshKey: number;
...
export default function AsmMetricsStrip({ orderNo, planQty, workers, refreshKey, scannedSg }: AsmMetricsStripProps) {
  ...
  return (
    ...
    >
      ...
      <Metric
        label={t('production.inputAssembly.scannedSg', '투입 SFG')}
