...
/**
 * @file production/subprocess-kitting-b/components/KitMaterialMountModal.tsx
 ...
 *   키팅도 같은 구조로 맞춘다: 왼쪽 참조 영역은 목록만 보여주고, 스캔은 이 모달에서 한다.
...
interface KitMaterialMountModalProps {
  isOpen: boolean;
  onClose: () => void;
  equipCode: string;
  orderNo?: string;
...
export default function KitMaterialMountModal({ isOpen, onClose, equipCode, orderNo, itemCode }: KitMaterialMountModalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="h-[560px] min-h-0" data-testid="subkit-b-material-mount-modal">
