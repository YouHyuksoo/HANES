 ...
 * @description 품질 스킨 C "데이터 월" — 라이트 신문 1면. 초대형 불량률 + 불량유형 랭킹 +
    ...
    <div className="w-full h-full flex flex-col overflow-hidden bg-[#f5f3ee] text-[#14120e]">
      ...
      <div className="flex items-baseline justify-between px-12 pt-6 pb-3.5 border-b-[6px] border-[#14120e] flex-shrink-0">
        <div className="flex items-baseline gap-6">
          <span className="text-4xl font-black">{t("monitoring.board.quality.title")}</span>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="w-[40%] border-r-2 border-[#14120e] flex flex-col px-12 pt-6 pb-8">
          ...
          <div className="mt-auto flex items-center gap-3.5 flex-wrap">
            <span className="bg-[#14120e] text-[#f5f3ee] text-lg font-bold px-4 py-1.5 tracking-[0.1em]">
            ...
            <span className="border-2 border-[#14120e] text-lg font-bold px-3.5 py-1 tracking-[0.1em]">
          ...
          <div className="flex-1 flex flex-col justify-evenly min-h-0">
            {topDefects.length === 0 ? (
              ...
              topDefects.slice(0, 6).map((d, i) => (
                <div key={d.defectCode} className="border-b border-[#cfcabd] last:border-b-0 py-2.5">
                  <div className="flex items-baseline gap-6">
                  ...
                  <div className="ml-20 mt-1.5 h-1.5 bg-[#e4e0d5]">
      ...
      {/* 하단: 7일 추이 스트립 */}
      <div className="flex items-stretch border-t-2 border-[#14120e] flex-shrink-0">
        <div className="px-12 py-3 flex items-center border-r border-[#cfcabd]">
        ...
        <div className="flex-1 flex divide-x divide-[#cfcabd]">
          {dailyTrend.map((d, i) => {
