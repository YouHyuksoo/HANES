 ...
 * @description 작업지시 보드 스킨 공통 타입/상수. 데이터 타입은 생산현황 보드(ProductionBoardOrder)를 재사용한다.
 */
...
export const STATUS_ORDER: Record<string, number> = { RUNNING: 0, HOLD: 1, WAITING: 2, DONE: 3 };
