 ...
 * @description 생산현황 보드(현장 TV) — 오늘 지시일 작업지시 KPI + 자동 순환 테이블 + 시간대별 실적
 *
 * 초보자 가이드:
 ...
 * 3. BoardChrome 의 TV 모드(전체화면)로 사이드바/헤더를 숨긴다
 */
  ...
  return (
    <>
      ...
      >
        ...
        {/* 시간대별 실적 차트 */}
        <div className="h-44 flex-shrink-0 rounded-xl border border-border bg-surface px-3 py-2">
