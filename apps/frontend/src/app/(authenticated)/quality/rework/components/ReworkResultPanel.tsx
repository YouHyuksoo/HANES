    ...
    <div className={`w-[480px] border-l border-border bg-background flex flex-col h-full overflow-hidden shadow-2xl text-xs ${animate ? "animate-slide-in-right" : ""}`}>
      ...
      <div className="px-5 py-3 border-b border-border flex items-center justify-between flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button size="sm" onClick={handleSubmit} disabled={saving || !canSubmit} disabledReason={saving ? t('common.disabled.processing', '처리 중입니다. 완료될 때까지 기다려 주세요.') : !form.workerId ? t('quality.disabled.worker', '작업자를 선택하세요.') : !form.resultQty ? t('quality.disabled.resultQty', '실적수량을 입력하세요.') : t('quality.disabled.workDetail', '작업 내용을 입력하세요.')}>
