...
export function createWorkInstructionGridColumns({
  ...
  return [
    ...
    { accessorKey: "processName", header: t("common.processName", "공정명"), size: 140, meta: { filterType: "text" as const }, cell: ({ getValue }) => getValue() || "-" },
    ...
    { accessorKey: "updatedAt", header: t("master.workInstruction.updatedAt"), size: 160, cell: ({ getValue }) => formatDateTimeKst(getValue() as string | null) },
    {
